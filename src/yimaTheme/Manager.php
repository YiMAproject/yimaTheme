    ...
    EventManagerAwareInterface
{
    ...
    protected function attachDefaultListeners()
    {
        ...
        $events->attach('Zend\Mvc\Controller\AbstractController', MvcEvent::EVENT_DISPATCH_ERROR, array($this,'addThemePathstack'),-91);
        $events->attach('Zend\Mvc\Controller\AbstractController', MvcEvent::EVENT_DISPATCH, array($this,'addThemePathstack'),-91);
